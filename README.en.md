...
| [`page-flip-showcase`](skills/page-flip-showcase/) · [full feature guide](docs/PAGE-FLIP-SHOWCASE.md) · [chat-ready file](chat-ready/page-flip-showcase.md) | Static, clickable one-page-at-a-time, and rendered page-flip outputs with adaptive collage backgrounds |
...
| [Vintage offset cinema](skills/vintage-offset-cinema-poster/)<br><img src="examples/vintage-offset-cinema-poster.png" alt="Vintage offset cinema" width="360"> | [Static page-flip showcase](skills/page-flip-showcase/)<br><img src="examples/page-flip-showcase.png" alt="Static page-flip showcase" width="360"><br>[Watch MP4 page-flip demo](examples/page-flip-showcase.mp4) |
